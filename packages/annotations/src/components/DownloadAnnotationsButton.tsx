...
const StyledButton = styled.button`
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 2px
      ${(props) => props.theme?.inputFocusBorder || "#007bff"}44;
  }
...
export const DownloadAnnotationsButton: React.FC<
  DownloadAnnotationsButtonProps
> = ({
  annotations,
  ...
  const handleDownload = () => {
    ...
    const jsonData = annotations.map((annotation) =>
      serializeAeneas(annotation),
    );
